import { j as jsxRuntimeExports, h as commonjsGlobal, i as getDefaultExportFromCjs, r as reactExports, k as clsx, l as React, m as invariant, d as cn, n as useParams, g as redirect, L as Link, S as Skeleton } from "./index-CgfZwU8L.js";
import { c as createLucideIcon, T as TriangleAlert, A as Activity, a as useAuth, u as useBackend, b as useQuery, s as showStressAlert, L as Layout, R as RefreshCw, E as EmotionBadge, C as Clock } from "./StressAlertToast-Cw8Ogjf1.js";
...
function formatTimestamp(ts) {
  const tsMs = Number(ts) > 1e12 ? Number(ts) / 1e6 : Number(ts) * 1e3;
...
function getAlertType(alert) {
  var _a;
  const lower = ((_a = alert.emotionState) == null ? void 0 : _a.toLowerCase()) ?? "";
  if (lower === "distressed") return "distressed";
  return "stress";
}
function AlertHistory({ alerts, childId }) {
  const filtered = alerts.filter((a2) => a2.childId === childId).sort((a2, b2) => Number(b2.timestamp) - Number(a2.timestamp)).slice(0, 5);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 py-3 border-b border-border bg-muted/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-semibold text-sm text-foreground flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "h-4 w-4 text-accent", "aria-hidden": "true" }),
          "Recent Alerts"
        ] }) }),
        filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-8 text-center", "data-ocid": "alert-history-empty", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm font-body", children: "No alerts recorded" })
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("ol", { className: "divide-y divide-border", "aria-label": "Alert history", children: filtered.map((alert) => {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium font-body bg-accent/20 text-accent border border-accent/30", children: type === "stress" ? "High Stress" : "Distressed" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground font-body", children: formatTimestamp(alert.timestamp) })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-foreground font-body mt-0.5", children: type === "stress" ? `Stress level: ${Math.round(alert.stressLevel)}%` : `Emotion: ${alert.emotionState}` })
                ] })
              ]
            },
            key
...
function buildChartData(readings, metric) {
  const last60 = readings.slice(-60);
  const now2 = Date.now();
  return last60.map((r, i) => {
    const tsMs = Number(r.timestamp) > 1e12 ? Number(r.timestamp) / 1e6 : Number(r.timestamp) * 1e3;
    const diffSec = Math.round((now2 - tsMs) / 1e3);
...
function ChartTooltip({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-card border border-border rounded-lg px-3 py-2 shadow-elevated text-xs font-body", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold text-foreground", children: [
...
function SensorChart({
  ...
  const xTickFormatter = (_, index) => {
    var _a;
    if (index === 0) return ((_a = data[0]) == null ? void 0 : _a.label) ?? "";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-sm text-foreground mb-3 tracking-tight", children: title }),
        isEmpty ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-40 flex items-center justify-center text-muted-foreground text-xs font-body", children: "No data yet" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 160, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          LineChart,
          {
            data,
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { content: /* @__PURE__ */ jsxRuntimeExports.jsx(ChartTooltip, { unit: unit2 }) }),
              dangerThreshold !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                ReferenceLine,
                {
                  y: dangerThreshold,
...
const CHART_COLORS = {
  hrv: "oklch(0.65 0.18 150)",
  // chart-1 green
  stressLevel: "oklch(0.68 0.18 25)",
  // accent coral
  motionIntensity: "oklch(0.65 0.17 240)"
  // chart-2 blue
};
function formatAge(age) {
  const n2 = Number(age);
  return n2 === 1 ? "1 yr" : `${n2} yrs`;
}
function getLatestEmotion(emotionHistory) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: ["a", "b", "c"].map((k2) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-52 rounded-xl" }, k2)) })
      ]
    }
  );
}
function ChildDetailPage() {
  ...
  const seenAlertIdsRef = reactExports.useRef(/* @__PURE__ */ new Set());
  reactExports.useEffect(() => {
    var _a2;
    if (!allAlerts.length || !detail) return;
    const childName = detail.profile.name;
    const childAlerts = allAlerts.filter((a2) => a2.childId === childIdBigInt);
    for (const alert of childAlerts) {
      const key = `${alert.childId}-${alert.timestamp}`;
      if (!seenAlertIdsRef.current.has(key)) {
        seenAlertIdsRef.current.add(key);
        const lower = ((_a2 = alert.emotionState) == null ? void 0 : _a2.toLowerCase()) ?? "";
        ...
        if (seenAlertIdsRef.current.size > childAlerts.length) {
          const stressAlert = {
            ...
            childName,
            alertType,
            stressLevel: alertType === "stress" ? alert.stressLevel : void 0,
            emotionState: alertType === "distressed" ? alert.emotionState : void 0,
  ...
  const latestReading = ((_a = detail == null ? void 0 : detail.recentReadings) == null ? void 0 : _a.length) ? [...detail.recentReadings].sort(
    (a2, b2) => Number(b2.timestamp) - Number(a2.timestamp)
  )[0] : null;
  const readings = (detail == null ? void 0 : detail.recentReadings) ?? [];
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/dashboard", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { className: "h-4 w-4 mr-1", "aria-hidden": "true" }),
                  "Dashboard"
                ] })
              }
            ),
            detail && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-border", "aria-hidden": "true", children: "/" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-xl text-foreground truncate", children: detail.profile.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mt-0.5 flex-wrap", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground font-body", children: [
                    "Age ",
                    formatAge(detail.profile.age)
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 text-xs text-muted-foreground font-body", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Cpu, { className: "h-3 w-3", "aria-hidden": "true" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: isFetching ? "Refreshing…" : "Live · 10s" })
              ]
            }
          )
        ] }),
        isLoading || authLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(DetailSkeleton, {}) : isError || !detail ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "flex flex-col items-center justify-center py-20 gap-4",
            "data-ocid": "child-detail-error",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-body text-sm", children: "Failed to load child details." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  variant: "outline",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-sm text-foreground", children: "Current Emotion" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      EmotionBadge,
                      {
                        emotion: (latestEmotion == null ? void 0 : latestEmotion.emotionState) ?? "unknown",
                        size: "md",
                        className: "text-base px-3 py-1.5"
                      }
                    ),
                    (latestEmotion == null ? void 0 : latestEmotion.confidence) !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground font-body", children: [
                      Math.round(latestEmotion.confidence * 100),
                      "% confidence"
                    ] })
                  ] }),
                  ((_b = latestEmotion == null ? void 0 : latestEmotion.careSuggestions) == null ? void 0 : _b.length) ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground/80 font-body leading-relaxed border-l-2 border-primary/30 pl-3", children: latestEmotion.careSuggestions[0] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-body italic", children: "No care suggestion available." })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-sm text-foreground", children: "Stress Level" }),
                  latestReading ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-2 mt-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          className: `font-display font-bold text-3xl tabular-nums ${latestReading.stressLevel > 70 ? "text-accent" : "text-foreground"}`,
                          children: Math.round(latestReading.stressLevel)
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground font-body text-sm mb-1", children: "/ 100" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 rounded-full bg-muted overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        className: `h-full rounded-full transition-smooth ${latestReading.stressLevel > 70 ? "bg-accent" : "bg-primary"}`,
                    ...
                    latestReading.stressLevel > 70 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-accent font-body font-medium", children: "⚠ Above danger threshold" })
                  ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-body", children: "No reading yet" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-sm text-foreground", children: "Heart Rate Variability" }),
                  latestReading ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-2 mt-1", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-3xl tabular-nums text-foreground", children: Math.round(latestReading.hrv) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground font-body text-sm mb-1", children: "ms" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body", children: "Normal range: 20–100 ms" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 mt-auto", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground font-body", children: [
                        "Motion: ",
                        Math.round(latestReading.motionIntensity),
                        " ",
                        "intensity"
                      ] })
                    ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(AlertHistory, { alerts: allAlerts, childId: childIdBigInt })
        ] })
      ]
    }
  ) });
