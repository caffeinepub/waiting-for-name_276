import { r as reactExports, j as jsxRuntimeExports, R as React, b as reactDomExports, c as ReactDOM, d as cn, e as useQueryClient, f as ue, L as Link, g as redirect, S as Skeleton } from "./index-CgfZwU8L.js";
import { c as createLucideIcon, u as useBackend, E as EmotionBadge, C as Clock, a as useAuth, b as useQuery, s as showStressAlert, L as Layout, R as RefreshCw } from "./StressAlertToast-Cw8Ogjf1.js";
import { c as composeRefs, u as useComposedRefs, a as createSlot$1, B as Button, S as Slot$1, b as cva } from "./button-COivdPDa.js";
/**
...
const Baby = createLucideIcon("baby", __iconNode$5);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const INITIAL = { name: "", age: "", deviceId: "" };
function AddChildModal({ open, onOpenChange }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      ue.error("Failed to add child. Please try again.");
      console.error(err);
    } finally {
      setSubmitting(false);
    }
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-8 w-8 items-center justify-center rounded-lg bg-primary/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(UserPlus, { className: "h-4 w-4 text-primary", "aria-hidden": "true" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { className: "font-display text-lg text-foreground", children: "Add Child" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { className: "text-sm text-muted-foreground mt-1", children: "Register a child profile to begin monitoring their health data." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-4 pt-2", noValidate: true, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            ...
            errors.name && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { id: "name-error", className: "text-xs text-destructive mt-1", children: errors.name })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Label,
            ...
            errors.age && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { id: "age-error", className: "text-xs text-destructive mt-1", children: errors.age })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Label,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                ...
                "aria-describedby": errors.deviceId ? "deviceId-error" : void 0,
                className: "bg-background border-input font-mono text-sm",
                "data-ocid": "add-child-deviceid-input"
              }
            ),
            errors.deviceId && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { id: "deviceId-error", className: "text-xs text-destructive mt-1", children: errors.deviceId })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-3 pt-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(X, { className: "h-4 w-4 mr-1", "aria-hidden": "true" }),
                  "Cancel"
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: submitting ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(UserPlus, { className: "h-4 w-4 mr-1.5", "aria-hidden": "true" }),
                  "Add Child"
                ] })
              }
            )
...
function StressBar({ value }) {
  ...
  const color2 = pct >= 70 ? "bg-accent" : pct >= 45 ? "bg-secondary" : "bg-primary/50";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground font-medium", children: "Stress Level" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "span",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 w-full rounded-full bg-muted overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: `h-full rounded-full transition-all duration-700 ${color2}`,
        style: { width: `${pct}%` },
        "aria-hidden": "true"
      }
    ) }),
...
function formatTimestamp(ts) {
  if (ts === void 0) return "No data yet";
...
function ChildSummaryCard({ child, index }) {
  ...
  const isDistressed = ((_a = child.latestEmotion) == null ? void 0 : _a.toLowerCase()) === "distressed";
    ...
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Card,
        {
          ...
          children: [
            showAlertBadge && /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5 space-y-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-base text-foreground truncate leading-tight", children: child.name }),
                  showAlertBadge && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Badge,
                    {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(StressBar, { value: stressLevel }),
              child.latestMotionIntensity !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-xs", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Motion" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground font-display", children: Math.round(child.latestMotionIntensity * 100) / 100 })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between pt-1 border-t border-border/60", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-[11px] text-muted-foreground min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "h-3 w-3 flex-shrink-0", "aria-hidden": "true" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: formatTimestamp(child.latestTimestamp) })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Link,
                  {
...
function DashboardSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: SKELETON_KEYS.map((key) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center pt-1 border-t border-border/60", children: [
...
function EmptyState({ onAdd }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-20 w-20 items-center justify-center rounded-full bg-primary/10 mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Baby, { className: "h-10 w-10 text-primary", "aria-hidden": "true" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-xl font-semibold text-foreground mb-2", children: "No children added yet" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground max-w-xs leading-relaxed mb-6", children: "Add your first child to start monitoring their emotion status and sensor readings in real time." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: onAdd, "data-ocid": "empty-add-child-btn", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CirclePlus, { className: "h-4 w-4 mr-2", "aria-hidden": "true" }),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-base font-semibold text-foreground mb-1", children: "Failed to load children" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mb-4", children: "There was a problem fetching your data. Please try again." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", onClick: onRetry, "data-ocid": "error-retry-btn", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: "h-4 w-4 mr-2", "aria-hidden": "true" }),
          "Retry"
        ] })
      ]
    }
...
function Dashboard() {
  ...
  const seenAlertIds = reactExports.useRef(/* @__PURE__ */ new Set());
  const registeredRef = reactExports.useRef(false);
  reactExports.useEffect(() => {
  ...
  reactExports.useEffect(() => {
    ...
    for (const alert of alerts) {
      ...
      const isDistressedAlert = ((_a = alert.emotionState) == null ? void 0 : _a.toLowerCase()) === "distressed";
      if (isStressAlert) {
        showStressAlert({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Layout, { children: [
      ...
      "div",
      {
        ...
        children: [
            ...
            motion.div,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl font-bold text-foreground tracking-tight", children: "KidiCare" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: "My Children — real-time emotion & sensor monitoring" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
                  {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-base font-semibold text-foreground", children: "Emotion Status" }),
            !showSkeleton && !isError && children && children.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground tabular-nums", children: [
              children.length,
              " ",
          ...
          showSkeleton ? /* @__PURE__ */ jsxRuntimeExports.jsx(DashboardSkeleton, {}) : isError ? /* @__PURE__ */ jsxRuntimeExports.jsx(ErrorState, { onRetry: () => refetch() }) : !children || children.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { onAdd: () => setModalOpen(true) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6",
              "data-ocid": "children-grid",
              children: children.map((child, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                ChildSummaryCard,
                {
                  child,
                  index
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AddChildModal, { open: modalOpen, onOpenChange: setModalOpen })
  ] });
}
export {
